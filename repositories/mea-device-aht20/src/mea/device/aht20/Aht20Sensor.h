...
/// @file Aht20Sensor.h
/// @brief Messquelle für genau eine AHT20-Messgröße (Kanal). Zwei Kanäle
///        (Temperatur, Luftfeuchte) teilen sich ein Aht20Device; jeder Kanal
...
///
/// Reihenfolge im Composition Root (ADR 0004): erst Aht20Device::begin(),
...
public:
    ...
    Aht20Sensor(Aht20Device& device, const Config& config) noexcept;
